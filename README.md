...
Problema are 2 etape principale:
1. **Descoperire**: Gasesc website-ul oficial al companiei (nu just caut VAT pe Google)
2. **Verificare**: Extrag VAT din website, verific cu HMRC si confirm ca apartine companiei corecte

Nu accept un VAT doar pentru ca are formatul bun. E valid doar daca:
- Trece verificarea checksum (9 cifre, calcul matematic)
- HMRC confirma ca e activ
- Numele si adresa se potrivesc exact cu Companies House
...
Website discovery e manual (research pe Google + documente) - asta e intenționat. De ce? Pentru că în etapa asta problema e validarea entității: "E acesta website-ul corect pentru compania asta?" Nu doar "pot accesa pagina?"
...
### Eșantionare (60 companii)

Am folosit **un singur eșantion** de 60 companii - nu m-am gândit la "ce companii probabil publică VAT". Orice alegere cu viciu ar falsifica rezultatele.

Teste pe surse alternative (Google, PDF-uri) s-au făcut - dar sunt exploratorii și nu-au schimbat coverage-ul principal.

**Sursă**: Companies House snapshot din 1 august 2026 (fișier 2,8 GB, nu-i în repo).

**Comandă**: `python src/sample_companies.py ... --size 60 --seed 42`

**Algoritm**: Stratificat pe 4 sectoare (manufacture, construcții, comerț, servicii) - 15 din fiecare. Seed fix (42) = reproductibil.

Eșantionul de 60 e bun pentru proof-of-concept. Pași viitori: 300-1000 companii.
